...
import { render, getByTestId, fireEvent } from "@testing-library/preact"
import createContainer from "../src"
import { PReactBase } from "../src/types"
...
describe("nestedDataChange", () => {
  let todosContainer: PReactBase<Todo[]>
  ...
  const getAppContainer = () => render(<App />)?.container as HTMLElement
